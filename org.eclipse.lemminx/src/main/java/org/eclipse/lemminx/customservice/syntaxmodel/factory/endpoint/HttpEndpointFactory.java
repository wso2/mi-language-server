...
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.endpoint.http.EnableSecAndEnableRMAndEnableAddressing;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.endpoint.http.EndpointHttp;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.endpoint.http.EndpointHttpAuthentication;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.endpoint.http.EndpointHttpAuthenticationBasicAuth;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.endpoint.http.EndpointHttpAuthenticationOauth;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.endpoint.http.EndpointHttpAuthenticationOauthAuthorizationCode;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.endpoint.http.EndpointHttpAuthenticationOauthClientCredentials;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.endpoint.http.EndpointHttpAuthenticationOauthPasswordCredentials;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.endpoint.http.EndpointHttpAuthenticationOauthRequestParameters;
