...
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.task.Task;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.task.TaskTrigger;
        ...
        if (children != null && !children.isEmpty()) {
            for (DOMNode node : children) {
                ...
                if (name.equals(Constant.TRIGGER)) {
                    ...
                    MediatorProperty mediatorProperty = Utils.createMediatorProperty(node);
