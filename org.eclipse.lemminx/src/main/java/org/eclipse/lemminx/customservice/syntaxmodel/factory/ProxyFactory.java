...
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.proxy.Proxy;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.proxy.ProxyPolicy;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.proxy.ProxyPublishWSDL;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.proxy.ProxyTarget;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.proxy.Resource;
        ...
        if (children != null && !children.isEmpty()) {
            for (DOMNode node : children) {
                ...
                if (name.equalsIgnoreCase(Constant.DESCRIPTION)) {
                    ...
                    STNode parameter = Utils.createParameter(node);
