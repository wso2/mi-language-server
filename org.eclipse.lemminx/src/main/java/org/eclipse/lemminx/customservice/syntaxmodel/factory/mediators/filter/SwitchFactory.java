...
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.filter.switchMediator.Switch;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.filter.switchMediator.SwitchCase;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.filter.switchMediator.SwitchDefault;
...
public class SwitchFactory extends AbstractMediatorFactory {
    ...
    private SwitchCase createSwitchCase(DOMNode child) {
        ...
        if (children != null && !children.isEmpty()) {
            List<Mediator> mediatorList = Utils.createMediators(children);
