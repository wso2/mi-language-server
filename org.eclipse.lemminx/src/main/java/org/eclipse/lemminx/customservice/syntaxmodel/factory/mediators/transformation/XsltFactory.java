...
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.transformation.xslt.Xslt;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.transformation.xslt.XsltFeature;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.transformation.xslt.XsltResource;
        ...
        if (childNodes != null && !childNodes.isEmpty()) {
            for (DOMNode childNode : childNodes) {
                if (childNode.getNodeName().equalsIgnoreCase(Constant.PROPERTY)) {
                    MediatorProperty mediatorProperty = Utils.createMediatorProperty(childNode);
