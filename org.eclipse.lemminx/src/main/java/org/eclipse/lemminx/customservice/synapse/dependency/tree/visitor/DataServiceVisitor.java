...
public class DataServiceVisitor extends AbstractDependencyVisitor {

    public DataServiceVisitor(DependencyTree dependencyTree, String projectPath) {
    ...
    public void visit(STNode node) {
        ...
        // No need to visit as there is no dependencies.
    }
}
