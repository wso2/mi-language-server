...
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.core.Feature;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.core.validate.Validate;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.core.validate.ValidateOnFail;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.core.validate.ValidateProperty;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.core.validate.ValidateResource;
import org.eclipse.lemminx.customservice.syntaxmodel.pojo.mediator.core.validate.ValidateSchema;
            ...
            for (DOMNode node : children) {
                ...
                if (nodeName.equalsIgnoreCase(Constant.PROPERTY)) {
                    ...
                    if (onFailChildren != null && !onFailChildren.isEmpty()) {
                        List<Mediator> mediators = Utils.createMediators(onFailChildren);
